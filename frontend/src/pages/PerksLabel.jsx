export default function Perks({selected,onChange}){
    ...
    return(
        <div className="grid grid-cols-2 md:grid-cols-3 gap-3 p-2">
                            <label className="border p-4 rounded-lg gap-2" >
                            ...
                            <label className="border p-4 rounded-lg gap-2">
                            <input type="checkbox" checked={selected.includes('alarm')} name='alarm' onChange={handlecbClick}></input>
                                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="size-6">
                            ...
                            <label className="border p-4 rounded-lg gap-2">
                            <input type="checkbox" checked={selected.includes('lift')} name='lift' onChange={handlecbClick}></input>
                                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="size-6">
